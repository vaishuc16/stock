...
const updateSearchHistory = searchValue => {
    ...
    /**
     * if the searched value is already present in search list then remove that one and add the search value at 
     *  the beginning of the search list
     * this ensure that the most recent search is at the top of the history.
     */
